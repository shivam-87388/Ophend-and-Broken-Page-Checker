...
<form onSubmit={handleSubmit} className="mt-2 p-4 ">
  ...
  <div className="flex items-center gap-3 mt-2">
    ...
    <button
      type="submit"
      className="finline-flex items-center justify-center px-3 py-2 mr-3 text-xl font-['Lora'] font-medium text-center text-black rounded-lg border-2 border-red-600 hover:bg-red-600 hover:text-white hover:border-transparent hover:ring-2 hover:ring-red-600 hover:ring-offset-2 transition-all duration-200"
    >
