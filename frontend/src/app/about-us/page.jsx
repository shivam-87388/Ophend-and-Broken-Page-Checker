...
const aboutus = () => {
  return (
    ...
    <p className="text-xl mt-2.5 md:text-2xl font-['Rosario']">Orphan pages are pages that exist on a website but are not linked from any internal page, making them hard for users and search engines to find.</p>
    <p className="text-xl mt-2.5 md:text-2xl font-['Rosario']">Broken links are links that return errors or fail to load properly, which can negatively impact user experience and search engine rankings.</p>
    <p className="text-xl mt-2.5 md:text-2xl font-['Rosario']">Our goal is to help you maintain a well-structured, SEO-friendly website by detecting these issues quickly and accurately.</p>
      </section>
      ...
      <section className="mt-4 p-4 bg-gray-100 rounded-2xl">
        ...
        <p className="text-xl md:text-2xl font-['Rosario']">Our mission is to make technical SEO simple, accurate, and accessible for everyone.</p>
        <p className="text-xl md:text-2xl font-['Rosario']">We aim to help users understand their website structure better and take informed actions to improve indexing, navigation, and search visibility.</p>
      </section>
