...
const page = () => {
  return (
    ...
    <h1 className="text-2xl md:text-3xl font-medium font-['Libre_Baskerville']">Find pages on your website that are not internally linked and invisible to search engines.
...
<section className="mt-4 p-4">
  <label htmlFor="website-url" className="text-2xl text-black">Enter your website URL</label>
  <div className='flex items-center border-2 gap-2 p-2 ml-2 border-gray-500 rounded-md w-[340px]'>
     <Link size={20} absoluteStrokeWidth />
     <input className="text-black outline-none flex-1" type="url" id="website-url" placeholder="https://example.com" required/>
  </div>
     <p className="text-red-600">*Make sure your sitemap is accessible and valid.</p>
